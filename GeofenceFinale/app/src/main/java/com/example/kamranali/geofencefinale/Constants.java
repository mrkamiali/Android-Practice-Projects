...
public class Constants {
    ...
    static {
        ...
        // OFFICE
        PanacloudLatLong.put("FinalePANACLOUD ", new LatLng(24.813505, 67.048358));

        // OFFICE
        PanacloudLatLong.put("FinaleHOME ", new LatLng(24.923880,67001465));

        //HOTEL
        PanacloudLatLong.put("FinaleHotel ", new LatLng(24.920905,66.992984));
//        // OFFICE
